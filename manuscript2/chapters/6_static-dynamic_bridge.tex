\chapter{Coexistance between the static world and the dynamic world}

\chapter{Hybrid solution: $n*n$ dispatch thanks to variants}

\chapter{JIT-based solutions: pros. and cons.}

\chapter*{Material about Static dynamic bridge}
\label{sec.bridge.sd}
