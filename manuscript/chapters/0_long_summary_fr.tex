...
pour le traiteur d'image lors du prototypage de son algorithme. Le temps passé à la mise en \oe{}uvre des fonctionnalités
...
\oe{}uvre d'algorithmes de traitement d'images. Cette nouvelle couche d'abstraction permet notament à l'utilisateur
...
est alors capable de se convertire au sein d'un dispatcher de cardinalité \(n \times n\) (dimension et type sous-jacent)
