...
\begin{figure}[htbp]
  ...
  \begin{tabular}{cccc}
    ...
    \fbox{\includegraphics[width=.29\linewidth]{figs/bench/PlnVsOpenCV_bg_sub_0}}                                                &
    \fbox{\includegraphics[width=.29\linewidth]{figs/bench/PlnVsOpenCV_bg_sub_pln_0}}                                                                             \\[5pt]
    \fbox{\includegraphics[width=.29\linewidth]{../assets/1512x1006/results_sig1_win5/garden/result_detected_garden_fg_1.png}}   &
    \fbox{\includegraphics[width=.29\linewidth]{figs/bench/PlnVsOpenCV_bg_sub_1}}                                                &
    \fbox{\includegraphics[width=.29\linewidth]{figs/bench/PlnVsOpenCV_bg_sub_pln_1}}                                                                             \\[5pt]
    \fbox{\includegraphics[width=.29\linewidth]{../assets/1512x1006/results_sig1_win5/pathway/result_detected_pathway_fg_1.png}} &
    \fbox{\includegraphics[width=.29\linewidth]{figs/bench/PlnVsOpenCV_bg_sub_6}}                                                &
    \fbox{\includegraphics[width=.29\linewidth]{figs/bench/PlnVsOpenCV_bg_sub_pln_6}}
  \end{tabular}
