...
\paragraph{Set \#1: castle} The figure~\cref{fig:bg_sub.castle.restults} presents the first candidate set we have run
the algorithm with.
...
in the figures~\cref{fig:bg_sub.castle.benchmarks} and~\cref{fig:bg_sub.castle.benchmarks.plnonly}.
...
figures~\cref{fig:bg_sub.garden.benchmarks}.
...
Finally, we have run our algorithm on a last original set of image presented in
figure~\cref{fig:bg_sub.pathway.restults}.
...
The breakdown of the benchmarks corresponding to this original set is presented in the
figures~\cref{fig:bg_sub.pathway.benchmarks}.
...
\FIXME{TODO: discussion sur les résultats à faire.}
