...
informations about strides. It is \emph{writable} when the values are mutable. It is accessible whenever it allows to
  ...
  \begin{scriptsize}
    \begin{threeparttable}
      ...
      \begin{tabular}{|l|l|cccccc|}
        \hline
        %\thead{View type}    & \backslashbox{\thead{Expression}}{\thead{Property}} & Forward & Bidirectional & Raw    & Writable   & Accessible & Indexable \\
