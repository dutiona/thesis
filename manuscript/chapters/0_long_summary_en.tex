...
\begin{figure}[htbp]
  ...
  \caption[]{Watershed algorithm applied to three different image types~\parencite{levillain.2014.ciarp}.}
...
Finally, for a tool whose aim is to be able to build a lot of different tools (i.e. providing a programming framework
...
The~\cref{summary:fig:type.vs.algo}~\parencite{levillain.2011.phd} illustrates the result of the same generic watershed
