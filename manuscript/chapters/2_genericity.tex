...
Stroustrup~\cref{stroustrup.1995.design,stroustrup.1999.hot,stroustrup.2003.concepts,stroustrup.2007.hopl} for years
with the coming of Concepts, and all the new possibilities it brings to the programmer.
...
\begin{itemize}
  ...
  \item passer en revue les solutions existantes :
        \begin{itemize}
          \item SWILENA~\parencite{beazley.1996.swig,olena.2000.www}
          \item VCSN~\parencite{demaille.2013.vcsn}
          \item VIGRA~\parencite{kothe.2011.generic}
          \item Cython~\parencite{behnel.2010.cython}
          \item cppyy~\parencite{wimtlplavrijsen.2016.cppyy}
          \item autowig~\parencite{fernique.2018.autowig}
          \item xeus-cling~\parencite{quantstack.2021.xeus-cling}
        \end{itemize}
\end{itemize}
