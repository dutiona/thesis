...
\begin{table}[tbh]
  ...
  \begin{threeparttable}
    ...
    \end{tabular}
    \begin{tablenotes}
      \item TC: type checking
      \item CS: code simplicity
      \item E: efficiency
      \item One IA: one implementation per algorithm
      \item EA: explicit abstractions / constrained genericity
    \end{tablenotes}
    \label{table:gen.approaches}
  \end{threeparttable}
\end{table}

The code duplication approach does not meet the requirements for code simplicity because of the copy/past mechanic
