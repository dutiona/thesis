...
with dynamic dispatching code (with run-time overhead). Each image processing library has its own way of handling
...
\begin{figure}[htbp]
  ...
  \subfloat[Different versions of \emph{fill} algorithms]{
    \includegraphics[width=1.9in]{figs/image_version}
  }%
  \hfil
  \subfloat[Specialization existing within a version]{
    \includegraphics[width=2.9in]{figs/image_version_specialization}
  }%
