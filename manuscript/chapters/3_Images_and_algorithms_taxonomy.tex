...
\FIXME{TODO : Definition of images and algorithms (introduction)}
...
compile time dispatch (static) that the interested reader can consult in appendix (appendix.dispatch.dyn.static).
