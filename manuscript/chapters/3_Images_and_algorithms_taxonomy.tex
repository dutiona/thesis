...
\label{image_and_algorithms_taxonomy.sec.image.set}
...
\label{image_and_algorithms_taxonomy.canvas.subsec.taxonomy}
...
\begin{table}[!htbp]
  \begin{scriptsize}
    ...
    \begin{tabular}{llll}
      ...
      \thead{Requirement}                                                                                                                                                                         \\
      \cline{1-4}
      \multicolumn{1}{c|}{\multirow{3}{*}{StructuringElement}} & \texttt{incremental}  & \multirow{3}{*}{\texttt{std::bool\_constant}} & \multirow{3}{*}{\makecell[l]{\texttt{std::true\_type} if \\ \texttt{std::false\_false} otherwise.}} \\
...
\begin{table}[!htbp]
  \begin{scriptsize}
    ...
    \begin{tabular}{llll}
      ...
      \cline{1-4}
      \multicolumn{1}{c|}{\multirow{4}{*}{\makecell[l]{Decomposable                                                                                                                                           \\StructuringElement}}} & \texttt{dse.is\_decomposable()} & \texttt{std::bool\_constant} & \makecell[l]{\texttt{std::true\_type} if \\ \texttt{std::false\_false} otherwise.}\\
      ...
      \cline{1-4}
      \multicolumn{1}{c|}{\multirow{4}{*}{\makecell[l]{Separable                                                                                                                                              \\StructuringElement}}} & \texttt{dse.is\_decomposable()} & \texttt{std::bool\_constant} & \makecell[l]{\texttt{std::true\_type} if \\ \texttt{std::false\_false} otherwise.}\\
...
\begin{table}[!htbp]
  \begin{scriptsize}
    ...
    \begin{tabular}{llll}
      ...
      \multicolumn{1}{c|}{}                              & \makecell[l]{\texttt{std::convertible\_to<}                                                                                                              \\\texttt{std::ranges::ranges\_value\_t<}\\\texttt{decltype(se.before(pnt))>, Pnt>}} & \multirow{4}{*}{\texttt{std::true\_type}}     & \multirow{2}{*}{Ranges that converts to compatible element types.} \\
...
\begin{table}[!htbp]
  ...
  \begin{scriptsize}
    ...
    \begin{tabular}{llll}
      ...
      \multicolumn{1}{c|}{}                           & \texttt{support\_fill}                 & \multirow{5}{*}{\texttt{std::bool\_constant}} & \multirow{5}{*}{\makecell[l]{\texttt{std::true\_type} if \\ \texttt{std::false\_false} otherwise.}} \\
  ...
  \label{concept.tables.extensions.definitions}
\end{table}
