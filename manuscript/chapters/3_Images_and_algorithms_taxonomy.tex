...
\begin{table}[!htbp]
  \begin{scriptsize}
    ...
    \begin{tabular}{llll}
      ...
      \multicolumn{1}{c|}{}                        & \texttt{indexable}          & \multirow{3}{*}{\texttt{std::bool\_constant}}  & \multirow{2}{*}{\makecell[l]{\texttt{std::true\_type} if supported, \\ \texttt{std::false\_false} otherwise.}} \\
      \multicolumn{1}{c|}{}                        & \texttt{accessible}         &                                                &                                                                     \\
      \multicolumn{1}{c|}{}                        & \texttt{view}               &                                                & \makecell[l]{\texttt{std::true\_type} if it is a view,              \\ \texttt{std::false\_false} otherwise.} \\
      \cline{1-4}
...
\begin{table}[!htbp]
  \begin{scriptsize}
    ...
    \begin{tabular}{llll}
      ...
      \multicolumn{1}{c|}{}                                    & \makecell[l]{\texttt{std::convertible\_to<}                                                                                                     \\\texttt{std::ranges::ranges\_value\_t<} \\\texttt{decltype(img.pixels())>, pixel\_type>}} & \multirow{2}{*}{\texttt{std::true\_type}}     & \multirow{2}{*}{\makecell[l]{Ranges converts to compatible\\ element types.}} \\
