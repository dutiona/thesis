...
\usepackage{pifont}
\newcommand{\cmark}{\colorbox{green!50!white}{\ding{51}}}%
\newcommand{\xmark}{\colorbox{red!50!white}{\ding{55}}}%
...
\begin{frame}[fragile]{Background subtraction pipeline with algorithms}
  ...
  \end{figure}
  \centering\textbf{5 intermediary images in memory.}
\end{frame}
...
\begin{frame}[fragile]{Background subtraction pipeline with views}
  ...
  \end{figure}
  \centering\textbf{1 intermediary image in memory.}
\end{frame}
