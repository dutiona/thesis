...
\author{\textbf{Michaël Roynard}\\
Supervision: \emph{Edwin Carlinet} \hspace{1cm} Direction: \emph{Thierry Géraud}}
...
\begin{frame}[fragile]{Need of Genericity for image processing}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{itemize}
      \item supported underlying image type (grayscale, rgb, floating-point, ...)
      \item supported data structure (ND-buffers, graphs, meshes, ...)
      \item additional data type (structuring element, label maps, ...)
    \end{itemize}
