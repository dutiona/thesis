...
\begin{frame}[fragile]{Image processing nowadays}
  ...
  \pnote{
    ...
    Différents périphériques/appareils

    Différentes Applications

    Coût en ressources de calcul élevée
  }
\end{frame}
...
\begin{frame}[fragile]{Taxonomy for Image Processing: Canvas for Dilation \& Erosion}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.50\textwidth}
    \includegraphics[width=0.55\textwidth]{../figures/local_op_dilation_code_rework}
    \includegraphics[width=0.55\textwidth]{../figures/local_op_erosion_code_rework}
  \end{columns}
\end{frame}
...
%FIXME perspectives haut niveau
%ouverture, continuer travail concepts non limité morpho maths
%synthèse image, 3D (+t vidéo?), maillages, graphs, (structures non-rectangulaires) etc.
% etc.
